    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/multilImageUploader.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/resources/nse/quick_photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
