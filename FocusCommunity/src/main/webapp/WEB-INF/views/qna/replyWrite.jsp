...
<body>
<form id="frm" action="/qna/replyWrite" method="post" enctype="multipart/form-data">
	<!--**********************************
    	Nav header start
	***********************************-->
				...
				<div class="col-lg-12">
                	<div class="card">
						<div class="card-header">
							<h4 class="card-title">질문 - 답글쓰기</h4>
						</div>
						<div class="card-body">
							...
							<div class="d-flex justify-content-center">
								...
								&nbsp;&nbsp;
								<button class="btn btn-dark btn-right btn-sl-sm mb-5" type="button" onclick="location.href='/qna/list?pageNum=${ pageNum }'">
