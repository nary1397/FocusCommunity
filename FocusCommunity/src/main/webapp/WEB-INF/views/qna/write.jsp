...
<body>
<form id="frm" action="/qna/write" method="post" enctype="multipart/form-data">
	<!--**********************************
    	Nav header start
	***********************************-->
                	...
                	<div class="card">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-center">
								...
								&nbsp;&nbsp;
								<button class="btn btn-dark btn-right btn-sl-sm mb-5" type="button" onclick="location.href='/qna/list?pageNum=${ pageNum }'"> 글목록</button>
							</div>								
						</div>
					</div>
				</div>
