                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="/admin/modify"  name="user" method="post">
                                        ...
                                        <br/>
                                       	<div class="text-center mt-4">
                                        	<button type="submit" class="btn btn-primary btn-block btn">회원정보 수정</button>
										</div>
										<div class="text-center mt-4">
                                        	<button type="button" class="btn btn-dark btn-block btn" onclick="location.href='/admin/content?cusid=${cususr.cusid}&pageNum=${pageNum}&type=${type}&keyword=${keyword}'">돌아가기</button>
										</div>
                                    </form>
                                </div>
                            </div>
