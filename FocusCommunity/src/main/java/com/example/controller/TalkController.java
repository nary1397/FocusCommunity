...
public class TalkController {
	...
	public void list(HttpSession sessoin, Criteria cri, Model model) {
		...
		BoardUtils.getList(cusbodService, sessoin, cri, model, "T");
	} // end of list
	...
	public String write(MultipartFile file, CusbodVO cusbodVO, @ModelAttribute("ctype") String ctype, String type, String pageNum, 
		...
		return BoardUtils.getWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "T", cusbodVO, model, rttr, "redirect:/talk/content");
	} // end of write
	...
	public void modify(Model model, HttpSession session, @ModelAttribute("pageNum") String pageNum, 
		...
		CusbodVO		cusbodVO	= cusbodService.selectCusbodAndAttatchAndRecom(csnum, "T", cusid);
		model.addAttribute("cusbodVO", cusbodVO);
	}
	...
	public String modify(MultipartFile file,@ModelAttribute("pageNum")  String pageNum,
		...
		return BoardUtils.getModify(attachService, cusbodService, file, cusbodVO, pageNum, type, keyword, request, delUuidList, rttr, "redirect:/talk/content");
	}
	...
	public String remove(Model model, @ModelAttribute("pageNum") String pageNum, 
		...
		// 글목록으로 리다이렉트 이동
		return BoardUtils.getRemove(attachService, cusbodService, pageNum, keyword, type, csnum, "T", "redirect:/talk/list", rttr);
	} // end of remove
	...
	public String replyWrite(@ModelAttribute("crerf") String crerf, 
		...
		String cusid = (String) session.getAttribute("sessionid");
		return BoardUtils.getReplyWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "T", cusbodVO, model, rttr, "redirect:/talk/content");
	}
	...
	public String reply(@ModelAttribute("pageNum") String pageNum, 
		...
		return BoardUtils.getReply(csreplService, pageNum, keyword, type, csnum, "T", rttr, request, id, cusid, "redirect:/talk/content");
	}
	...
	public String replyModify(@ModelAttribute("pageNum") String pageNum, 
		...
		return BoardUtils.getReplyModify(csreplService, pageNum, keyword, type, csnum, "T", rttr, request, id, cusid, conum, "redirect:/talk/content");
	}
	...
	public String replyRemove(@ModelAttribute("pageNum") String pageNum, 
		...
		String 	id 		= (String) session.getAttribute("sessionid");
		int 	conum	= Integer.parseInt(request.getParameter("conum"));
		return BoardUtils.getReplyRemove(csreplService, pageNum, keyword, type, csnum, "T", rttr, request, id, cusid, conum, "redirect:/talk/content");
	}
	...
	public String replyRe(@ModelAttribute("pageNum") String pageNum, 
			...
			String ctype, RedirectAttributes rttr, HttpServletRequest request, HttpSession session) {
		String 	id 		= (String) session.getAttribute("sessionid");
		return BoardUtils.getReplyRe(csreplService, pageNum, keyword, type, csnum, "T", rttr, request, id, cusid, "redirect:/talk/content");
	}
