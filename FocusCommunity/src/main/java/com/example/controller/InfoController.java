...
public class InfoController {
	...
	public void list(HttpSession sessoin, Criteria cri, Model model) {
		...
		BoardUtils.getList(cusbodService, sessoin, cri, model, "I");
	} // end of list
	...
	public String write(MultipartFile file, CusbodVO cusbodVO, @ModelAttribute("ctype") String ctype, String type, String pageNum, 
		...
		return BoardUtils.getWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "I", cusbodVO, model, rttr, "redirect:/info/content");
	} // end of write
	...
	public void modify(Model model, HttpSession session, @ModelAttribute("pageNum") String pageNum, 
		...
		CusbodVO		cusbodVO	= cusbodService.selectCusbodAndAttatchAndRecom(csnum, "I", cusid);
		model.addAttribute("cusbodVO", cusbodVO);
	}
	...
	public String modify(MultipartFile file,@ModelAttribute("pageNum")  String pageNum,
		...
		return BoardUtils.getModify(attachService, cusbodService, file, cusbodVO, pageNum, type, keyword, request, delUuidList, rttr, "redirect:/info/content");
	}
	...
	public String remove(Model model, @ModelAttribute("pageNum") String pageNum, 
		...
		// 글목록으로 리다이렉트 이동
		return BoardUtils.getRemove(attachService, cusbodService, pageNum, keyword, type, csnum, "I", "redirect:/info/list", rttr);
	} // end of remove
	...
	public String replyWrite(@ModelAttribute("crerf") String crerf, 
		...
		String cusid = (String) session.getAttribute("sessionid");
		return BoardUtils.getReplyWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "I", cusbodVO, model, rttr, "redirect:/info/content");
	}
	...
	public String reply(@ModelAttribute("pageNum") String pageNum, 
		...
		return BoardUtils.getReply(csreplService, pageNum, keyword, type, csnum, "I", rttr, request, id, cusid, "redirect:/info/content");
	}
	...
	public String replyModify(@ModelAttribute("pageNum") String pageNum, 
		...
		return BoardUtils.getReplyModify(csreplService, pageNum, keyword, type, csnum, "I", rttr, request, id, cusid, conum, "redirect:/info/content");
	}
	...
	public String replyRemove(@ModelAttribute("pageNum") String pageNum, 
		...
		String 	id 		= (String) session.getAttribute("sessionid");
		int 	conum	= Integer.parseInt(request.getParameter("conum"));
		return BoardUtils.getReplyRemove(csreplService, pageNum, keyword, type, csnum, "I", rttr, request, id, cusid, conum, "redirect:/info/content");
	}
	...
	public String replyRe(@ModelAttribute("pageNum") String pageNum, 
			...
			String ctype, RedirectAttributes rttr, HttpServletRequest request, HttpSession session) {
		String 	id 		= (String) session.getAttribute("sessionid");
		return BoardUtils.getReplyRe(csreplService, pageNum, keyword, type, csnum, "I", rttr, request, id, cusid, "redirect:/info/content");
	}
