...
public class ReviewController {
	...
	public String write(MultipartFile file, CusbodVO cusbodVO, @ModelAttribute("ctype") String ctype, String type, String pageNum, 
		...
		return BoardUtils.getWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "R", cusbodVO, model, rttr, "redirect:/review/content");
	} // end of write
	...
	public String modify(MultipartFile file,@ModelAttribute("pageNum")  String pageNum,
		...
		return BoardUtils.getModify(attachService, cusbodService, file, cusbodVO, pageNum, type, keyword, request, delUuidList, rttr, "redirect:/review/content");
	}
	...
	public String remove(Model model, @ModelAttribute("pageNum") String pageNum, 
		...
		// 글목록으로 리다이렉트 이동
		return BoardUtils.getRemove(attachService, cusbodService, pageNum, keyword, type, csnum, "R", "redirect:/review/list", rttr);
	} // end of remove
	...
	public String replyWrite(@ModelAttribute("crerf") String crerf, 
		...
		String cusid = (String) session.getAttribute("sessionid");
		return BoardUtils.getReplyWrite(cusbodService, file, request, pageNum, keyword, type, cusid, "R", cusbodVO, model, rttr, "redirect:/review/content");
	}
